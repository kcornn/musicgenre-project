...
from keras.layers import Conv1D, Conv2D, BatchNormalization, MaxPooling1D, Flatten
...
def build_crnn():
    ...
    cb = ModelCheckpoint('crnn-gru-best.h5', monitor='val_loss', mode='min', save_best_only=True)
...
plot_model(savemodel, to_file='model-crnn-gru.png')
saved_model = load_model('crnn-gru-best.h5')
...
plt.savefig('cf-matrix-crnn-gru.png')
plt.clf()
...
plt.savefig('accuracy-crnn-gru.png')
plt.clf()

...
def build_crnn():
    ...
    layer = Flatten()(layer)
    layer = Dense(8, activation="softmax")(layer) # For number of classes
    model_output = layer
    ...
    cb = ModelCheckpoint('cnn-best.h5', monitor='val_loss', mode='min', save_best_only=True)
...
plot_model(savemodel, to_file='model-cnn.png')
saved_model = load_model('cnn-best.h5')
